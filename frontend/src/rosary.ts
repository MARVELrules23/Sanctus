...
export function openingBeads(): BeadStep[] {
  return [
    ...
    { label: "Our Father", prayer: "Our Father, Who art in heaven, hallowed be Thy name…" },
    { label: "Hail Mary (for Faith)", prayer: "Hail Mary, full of grace, the Lord is with thee…" },
    { label: "Hail Mary (for Hope)", prayer: "Hail Mary, full of grace…" },
    { label: "Hail Mary (for Charity)", prayer: "Hail Mary, full of grace…" },
    { label: "Glory Be", prayer: "Glory be to the Father, and to the Son, and to the Holy Spirit…" },
  ];
}
...
export function decadeBeads(idx: number, mystery: Mystery): BeadStep[] {
  ...
  beads.push({ label: "Our Father", prayer: "Our Father, Who art in heaven…" });
  for (let i = 1; i <= 10; i++) {
    beads.push({ label: `Hail Mary (${i}/10)`, prayer: "Hail Mary, full of grace, the Lord is with thee…" });
  }
  beads.push({ label: "Glory Be", prayer: "Glory be to the Father, and to the Son, and to the Holy Spirit…" });
  beads.push({
    label: "Fatima Prayer",
    prayer:
